...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:20}: {:3d}".format('N Not-Dog Images', results_stats_dic['n_notdogs_img']))    # 6a
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            result_1 = results_dic[key][3] and results_dic[key][4]==0
            result_2 = results_dic[key][3]==0 and results_dic[key][4]
            if result_1 or result_2:
                print('Pet Label:{} and Classifier Label: {}'.format(results_dic[key][0], results_dic[key][1]))
