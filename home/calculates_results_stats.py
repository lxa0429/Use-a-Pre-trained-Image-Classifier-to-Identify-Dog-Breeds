...
#                                                                             
# PROGRAMMER: Ah Liang
# DATE CREATED:  09 Aug 2022                                
# REVISED DATE:  10 Aug 2022
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:        
        ...
        if results_dic[key][3] == 1:
            ...
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1         # 5a
        else:
            # Classifier classifies image as NOT a Dog(& pet image isn't a dog)
            # counts number of correct NOT dog clasifications.
            if results_dic[key][4] == 0:
                results_stats_dic['n_correct_notdogs'] += 1     # 5b
    
    print('number of labels match ', results_stats_dic['n_match'])
    
    print('number of correct breed', results_stats_dic['n_correct_breed'])
    print('number of dog images ', results_stats_dic['n_dogs_img'])
    print('number of correct dog classifications ', results_stats_dic['n_correct_dogs'])
    print('number of correct NOT dog classifications ', results_stats_dic['n_correct_notdogs'])
    # calculates number of total images
    results_stats_dic['n_images'] = len(results_dic)
    print('number of total images ', results_stats_dic['n_images'])
    ...
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / results_stats_dic['n_images']) * 100   # 5c
    print('pct_match ', results_stats_dic['pct_match'])
        
    # Calculates % correct dogs
    if results_stats_dic['n_dogs_img'] > 0:
        results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img'])*100   # 5d
    else:
    ...
    if results_stats_dic['n_dogs_img'] > 0:   
        results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed'] / results_stats_dic['n_dogs_img'])*100 # 5e
    else:
